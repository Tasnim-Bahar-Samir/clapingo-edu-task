...
const TrialSection = () => {
  ...
  return (
    <div className='flex xl:gap-40 md:gap-12  mt-[120px]' >
        <div className='md:pl-[120px] grid grid-cols-2 gap-8 w-1/2 py-16' style={{background:'linear-gradient(90deg, #00D2FF -13.02%, rgba(0, 210, 255, 0) 103.77%)'}}>
            {data.map(d => (
                <div key={d._id} className={`rounded-xl flex items-center justify-center text-white text-center ${d._id === 3 && 'ml-4'} ${d._id === 4 && 'ml-4'}`} style={{backgroundColor:'#3A3636'}}>
                    <div>
        ...
        <div className='w-1/2 md:pr-[120px]'>
