...
const Banner = () => {
  return (
    <div className="flex gap-1 md:flex-row flex-col-reverse px-10 md:px-12 xl:px-[120px] mt-14">
      <div>
        ...
        <div className="mt-12 flex gap-8">
            ...
            <button className="py-[15px] px-[32px] rounded-[80px] border hover:secondary-bg download-btn hover:text-white color-secondary">Download our app</button>
        </div>
      </div>
      <div>
